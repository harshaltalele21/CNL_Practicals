...
public class ServerDemo {
	...
	public static void main(String[] args) {
		...
		ServerDemo serverObject = new ServerDemo(7891);
	...
	public void startServer() {
		try {
			...
			server = new ServerSocket(5001); //ServerSocket class attempts to create a server socket bound to the specified port. An exception occurs if the port is already bound by another application. Usage = (port_no))
