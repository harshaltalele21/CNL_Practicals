...
if (argc < 3) {
	 ...
	 printf("Enter 4 bits of data one by one\n");
   	 scanf("%d",&data[0]); //oolta sequence..from left to right
   	 scanf("%d",&data[1]);
   	 scanf("%d",&data[2]);
   	 scanf("%d",&data[4]);
    
     //Calculation of even parity
    data[6]=data[0]^data[2]^data[4]; //1 3 5
    data[5]=data[0]^data[1]^data[4]; //1 2 5
    data[3]=data[0]^data[1]^data[2]; //1 2 3
  ...
  //    //Calculation of even parity
  //   data[0]=data[2]^data[4]^data[6]; //1 3 5
  //   data[1]=data[2]^data[5]^data[6]; //1 2 5
  //   data[3]=data[4]^data[5]^data[6]; //1 2 3
